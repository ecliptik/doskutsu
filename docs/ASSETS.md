...
**Selecting a set at runtime** (SETUP's MIDI-set row, or by hand): WiiWare =
`MIDI_SET=wiimidi` (default) -> `data/midi/`; OrgMIDI v2 = `MIDI_SET=orgmid`
plus `MIDI_GM_VARIANT=v2` -> `data/orgmid2/` (the `SDL_HINT_DOSKUTSU_AUDIO_MIDI_SOURCE`
